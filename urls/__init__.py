...
from real_estate_app.apps.visitcalendar.urls import visitcalendar_list_json, visitcalendar_list, visitcalendar_list_proprety_visit, visitcalendar_create_object, visitcalendar_update_object

urlpatterns = patterns('', 
						contact, send_content, 
						feeds_newspapers_url, newspapers_list, newspapers_detail, 
					    portlet_edit, portlet_create, 
					    visitcalendar_list_json, visitcalendar_list_proprety_visit, visitcalendar_list, visitcalendar_create_object, visitcalendar_update_object,
